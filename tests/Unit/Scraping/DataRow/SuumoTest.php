...
class SuumoTest extends BaseDataRowTestCase
{
    protected function setDataRowClass(){
        return SuumoDataRow::Class;
    }
    ...
    {
        $stdPropertyArray = ['price' => "1,300d万円",'landarea' => "270.36m2","location"  => "宮城県仙台市青葉区荒巻本沢３丁目","traffic" => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""];
    ...
    {
        $stdPropertyArray =  ['price' => "8,000万円",'landarea'  => "162.66m2","location"  => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic"    => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""];
     ...
     * @return void
     */
    public function convertDoublePricePattern()
    {
        $stdPropertyArray =  [
            ['price' => "8,000万円～9,000万円",'landarea'  => "162.66m2","location"  => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic"    => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""],
            ['price' => "8,000万円・9,000万円",'landarea'  => "162.66m2","location"  => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic"    => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""]
        ];
        $expectResultArray =   [
            ['minimum_price' => "80000000",'maximum_price' => "90000000",'minimum_land_area' => "162.66","location_original" => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic" => "東北線　仙台停歩　4分/バス　28分","url" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""],
            ['minimum_price' => "80000000",'maximum_price' => "90000000",'minimum_land_area' => "162.66","location_original" => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic" => "東北線　仙台停歩　4分/バス　28分","url" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""]
        ];
    ...
    {
        $stdPropertyArray =  ['price' => "10億500万円",'landarea'  => "162.66m2","location"  => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic"    => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""];
    ...
    {
        $stdPropertyArray =  ['price' => "1億5000万円",'landarea'  => "162.66m2","location"  => "宮城県仙台市ERROR青葉区上杉６丁目d","traffic"    => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""];
    ...
    {       
        $stdPropertyArray =   [
            ['price' => "1,960万円",'landarea'  => "176.91m2","location"  => "宮城県仙台市青葉区荒巻本沢３丁目","traffic" => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""],
            ['price' => "3,260万円",'landarea'  => "136.30m2","location"  => "宮城県仙台市青葉区角五郎１丁目","traffic" => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""],
            ['price' => "3,200万円",'landarea'  => "136.31m2","location"  => "宮城県仙台市青葉区角五郎１丁目","traffic" => "東北線　仙台停歩　4分/バス　28分","URL" => "test","publication_destination" => "atHome","land_status" => "","property_no" =>""]
        ];
