            ...
            <div class="col-md-9 col-lg-10 col-content">
                <div class="row mx-n2 mt-2 mt-md-0">
                    <div class="px-2 col-lg-9">
                        <select v-if="companyuser.length>1" class="form-control form-control-sm" v-model.number="user" name="company_users_id" :required="required">
                            <option value=""></option>
                            <option v-for="option in companyuser" :value="option.id">@{{ option.name }}</option>
                        </select>

                        <select v-else class="form-control form-control-sm" name="company_users_id" :required="required">
                            <option selected v-for="option in companyuser" :value="option.id">@{{ option.name }}</option>
                        </select>
                    </div>
                </div>
            </div>
