            ...
            computed: {
                ...
                city: {
                    get: function(){
                        var vm = this;
                        // ------------------------------------------------------
                        // Do xhr request to get the City list
                        // ------------------------------------------------------
                        var request = axios.post( this.townAPI, { city: this.entry.cities_id });
                        ...
                        return io.get( this.entry, 'cities_id' )
                    },
                    set: function( value ){ 
                        // ------------------------------------------------------
                        var vm = this;
                        ...
                        // ------------------------------------------------------
                        // Do xhr request to get the Town list
                        // ------------------------------------------------------
