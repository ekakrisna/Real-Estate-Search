<script type="text/x-template" id="tablelike-result-item-tpl">
    <div class="tablelike-item border-top border-right mt-3 mt-xl-0">
        <div class="row mx-0">
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-md col-lg col-xl-90px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2">
                            <a v-if="inquiry.property" target="_blank" :href="inquiry.property.url.manage_view">@{{ propertyId }}</a>
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-md col-lg col-xl-180px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2">
                            <div v-if="inquiry.property">                                
                                @{{ building_desc ? building_desc : '@lang('label.none')' }}
                            </div>
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-md-6 col-lg-6 col-xl-100px">
                <div class="border-top d-xl-none"></div>
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    <div class="px-0 col-100px col-sm-150px border-right d-xl-none bg-light">
        ...
        (function($, io, document, window, undefined) {
            ...
            Vue.component('ResultItem', {
                ...
                computed: {
                    ...
                    propertyPriceRange: function() {
                        return this.inquiry.property && this.inquiry.property ?
                            Vue.filter('toMan')(this.inquiry.property.minimum_price) + ' ~ ' +
                            Vue.filter('toMan')(this.inquiry.property.maximum_price) :
                            '@lang('label.none')';
                    },
                    propertyLandAreaRange: function() {
                        return this.inquiry.property && this.inquiry.property ?
                            Vue.filter('toTsubo')(this.inquiry.property.minimum_land_area) + ' ~ ' +
                            Vue.filter('toTsubo')(this.inquiry.property.maximum_land_area) :
                            '@lang('label.none')';
                    },
                },
                methods: {},
