<script type="text/x-template" id="generic-input-email-unique-edit-tpl">
            ...
            <div class="row mx-n2 mt-2 mt-md-0">
                <div class="px-2 col-lg-9">
                    <input type="email" :value="value" class="form-control form-control-sm" :name="name" :id="id" :required="required ? true : false"
                        ...
                        data-parsley-email-exists="[{{ route( 'api.customer_email.exists' )}},{{ $customer->id }}]"/>
                </div>
            </div>
        </div>
...
<script> @minify
    (function( $, io, document, window, undefined ){
        Vue.component( 'InputEmailUniqueEdit', {
            // ------------------------------------------------------------------
            template: '#generic-input-email-unique-edit-tpl',
            // ------------------------------------------------------------------
