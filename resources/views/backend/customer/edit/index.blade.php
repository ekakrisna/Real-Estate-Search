...
@section('content')
    ...
    <form class="parsley-minimal" data-parsley>
        <div class="position-relative">
            ...
            <range-price name1="minimum_price_land_area" name2="maximum_price_land_area" :min.sync="customer.minimum_price_land_area" :max.sync="customer.maximum_price_land_area" 
                label="@lang('label.min_land')" append="万円" required>
            </range-price>

            <range-land name1="minimum_land_area" name2="maximum_land_area" :min.sync="customer.minimum_land_area" :max.sync="customer.maximum_land_area" 
                label="@lang('label.min_desired_land')" append="坪" required>
            </range-land>
            ...
            var state = {
                ...
                preset: {
                    ...
                    api: {
                        ...
                        store: @json( route( 'admin.customer.edit.update', $customer->id ))
                    },
                    // -----------------------------------------------------
