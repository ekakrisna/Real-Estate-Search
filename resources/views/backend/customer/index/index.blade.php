    ...
    <div class="tablelike mt-4">
        ...
        <div class="tablelike-header border-top border-right d-none d-xl-block">
            <div class="row mx-0">
                ...
                <div class="px-0 border-left bg-light col-12 col-xl-70px"><div class="py-2 px-2">@lang('label.edit')</div></div>
                <div class="px-0 border-left bg-light col-12 col-xl-70px"><div class="py-2 px-2">@lang('label.detail')</div></div>
            </div>
        </div>
        <!-- Table header - End -->
...
<script> @minify
    (function( $, io, document, window, undefined ){
        ...
        router = {
            mode: 'history',
            routes: [{ 
                name: 'index', path:'/admin/customer/',
                ...
                var state = {
                    ...
                    preset: {
                        ...
                        orders: [
                            ...
                            { id: 'company', label: '@lang('label.in_charge_company')' },
            ...
            watch: {
                ...
                $route: {
                    ...
                    handler: function( to, from ){
                        ...
                        var url = @json(route( 'admin.customer.list.filter' ));
