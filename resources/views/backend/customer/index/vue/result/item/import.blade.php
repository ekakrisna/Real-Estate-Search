<script type="text/x-template" id="tablelike-result-item-tpl">
    <div class="tablelike-item border-top border-right mt-3 mt-xl-0">
        <div class="row mx-0">
            ...
            <!-- ID column - Start -->
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-80px">
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-180px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2">@{{ !user.company_user ? 'ー' : user.company_user.company.company_name}}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-180px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2">@{{ !user.company_user ? 'ー' : user.company_user.name}}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-150px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2">@{{ user.customer_last_activity ? user.customer_last_activity.ja.access_date : '' }}</div>
                    </div>
                </div>
            </div>
           ...
           <!-- Company edit button - Start -->
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-70px">
                <div class="border-top d-xl-none"></div>
                <div class="row h-100 mx-0 my-auto flex-nowrap flex-grow-1">
                    <div class="px-0 col-100px col-sm-150px border-right d-xl-none bg-light">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2 d-flex justify-content-xl-center">
                            <a target="_blank" class="btn btn-sm btn-info text-white fs-12" :href="user.url.edit">
                                @lang('label.edit')
                            </a>
                        </div>
                    </div>
            ...
            <div class="px-0 d-flex flex-column border-left col-12 col-lg-6 col-xl-70px">
                ...
                <div class="row mx-0 flex-nowrap flex-grow-1">
                    ...
                    <div class="px-0 col col-xl-12 overflow-hidden">
                        <div class="py-2 px-2 d-flex justify-content-xl-center">                                
                            <a target="_blank" class="btn btn-sm btn-info text-white fs-12 fs-xs-0-9" :href="user.url.view">
                                @lang('label.detail')
                            </a>                                                                                                
                        </div>
                    </div>
