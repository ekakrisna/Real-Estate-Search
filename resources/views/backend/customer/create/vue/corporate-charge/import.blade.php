    ...
    <div class=" align-items-start">
            ...
            <div class="col-md-9 col-lg-10 col-content">
                <div class="row mx-n2 mt-2 mt-md-0">
                    <div class="px-2 col-lg-9">
                        <select class="form-control form-control-sm" v-model.number="company" name="company_name" :required="required">
                            <option value=""></option>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-9 col-lg-10 col-content">
                <div class="row mx-n2 mt-2 mt-md-0">
                    <div class="px-2 col-lg-9">
                        <select class="form-control form-control-sm" v-model.number="user" :disabled="!company" name="company_users_id" :required="!!company">
                            <option value=""></option>
