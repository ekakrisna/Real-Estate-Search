<script type="text/x-template" id="generic-input-email-unique-tpl">
        ...
        <div class="col-md-9 col-lg-10 col-content">
            <div class="row mx-n2 mt-2 mt-md-0">
                <div class="px-2 col-lg-9">
                    <input type="email" :value="value" class="form-control form-control-sm" :name="name" :id="id" :required="required"
                        @input="$emit( 'input', $event.target.value )" 
                        data-parsley-trigger="focusout" data-parsley-email-exists="[{{ route( 'api.customer_email.exists' )}},0]"/>
                </div>
            </div>
        </div>
...
<script> @minify
    (function( $, io, document, window, undefined ){
        Vue.component( 'InputEmailUnique', {
            // ------------------------------------------------------------------
            template: '#generic-input-email-unique-tpl',
            // ------------------------------------------------------------------
