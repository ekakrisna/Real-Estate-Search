<script type="text/x-template" id="generic-input-phone-tpl">
        ...
        <div class="col-md-9 col-lg-10 col-content">
            <div class="row mx-n2 mt-2 mt-md-0">
                <div class="px-2 col-lg-9">
                    <input type="text" :value="value" class="form-control form-control-sm @error('{{name}}') is-invalid @enderror" :name="name" :id="id" :required="required ? true : false"
                        @input="$emit( 'input', $event.target.value )"  data-parsley-minlength="8" data-parsley-trigger="focusout" data-parsley-phone-number />
                </div>
            </div>
        </div>
...
<script> @minify
    (function( $, io, document, window, undefined ){
        Vue.component( 'InputPhone', {
            // ------------------------------------------------------------------
            template: '#generic-input-phone-tpl',
            // ------------------------------------------------------------------
