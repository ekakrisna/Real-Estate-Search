<script type="text/x-template" id="page-filters-tpl">
    <div class="row mb-4">
        ...
        <div class="col-md-6">@relativeInclude('includes.report_bug')</div>
        ...
        <div class="col-md-6">@relativeInclude('includes.building_condition')</div>
        <div class="col-md-6">@relativeInclude('includes.photo')</div>
        <div class="col-md-6">@relativeInclude('includes.flyer')</div>
        ...
        Vue.component( 'Filters', {
            ...
            data: function(){
                ...
                var data = {
                    filter: {},
                    defaultFilter: {
                        id: null, location: '', priceMin: '', priceMax: '', 
                        landAreaMin: '', landAreaMax: '', updateDateStart: '', 
                        updateDatEnd: '', propertyStatus: '', buildingConditionYes: 1,buildingConditionNo : 1,
                        photoTrue: 1, photoFalse: 1, flyerTrue: 1, flyerFalse: 1, reportBugTrue: 1, reportBugFalse: 1,
            ...
            computed: {
                ...
                // --------------------------------------------------------------
                filterId: {
                    get: function(){ return io.parseInt( io.get( this.filter, 'id' ))},
                    set: function( value ){ this.filter.id = value }
                },
                // --------------------------------------------------------------
                // --------------------------------------------------------------
