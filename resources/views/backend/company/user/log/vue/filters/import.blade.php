<script type="text/x-template" id="page-filters-tpl">
    <div class="row">
        ...
        <div class="col-12">
            <div class="row mx-n3">
                ...
                <div class="px-3 col-auto d-flex align-items-center">
                    <a href="javascript:;" @click.prevent="resetFilter" id="resetFilter">@lang('label.reset_search_codition')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">@relativeInclude('includes.username')</div>
        <div class="col-md-6">@relativeInclude('includes.email')</div>
        <div class="col-md-6">@relativeInclude('includes.authority')</div>
        ...
        Vue.component( 'Filters', {
            ...
            data: function(){
                ...
                var data = {
                    filter: {},
                    defaultFilter: {
                        datestart: null, datefinish: null,
                        name: '', username: '',
                        email: '',
                        authority: null, action: null,
