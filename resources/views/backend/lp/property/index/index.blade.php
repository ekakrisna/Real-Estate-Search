    ...
    <div class="tablelike">
        ...
        <div class="tablelike-header border-top border-right d-none d-xl-block">
            <div class="row mx-0">
                ...
                <div class="px-0 border-left bg-light col-xl-100px"><div class="py-2 px-2">@lang('label.property_id')</div></div>
                <div class="px-0 border-left bg-light col-xl"><div class="py-2 px-2">@lang('label.location')</div></div>
                <div class="px-0 border-left bg-light col-xl-80px"><div class="py-2 px-2">@lang('label.selling_price_lp')</div></div>
                <div class="px-0 border-left bg-light col-xl-80px"><div class="py-2 px-2">@lang('label.land_area_lp')</div></div>
                <div class="px-0 border-left bg-light col-xl-80px"><div class="py-2 px-2">@lang('label.buliding_area_lp')</div></div>
                ...
                <div class="px-0 border-left bg-light col-xl-80px"><div class="py-2 px-2">@lang('label.house_layout')</div></div>
                <div class="px-0 border-left bg-light col-xl-90px"><div class="py-2 px-2">@lang('label.connecting_road')</div></div>
                <div class="px-0 border-left bg-light col-xl-50px"><div class="py-2 px-2"></div></div>
            </div>
        </div>
        <!-- Table header - End -->
...
<script> @minify
    (function( $, io, document, window, undefined ){
        ...
        router = {
            mode: 'history',
            routes: [{ 
                name: 'index', path: '/admin/lp/property', 
            ...
            watch: {
                ...
                $route: {
                    ...
                    handler: function( to, from ){
                        ...
                        var url = @json( route( 'admin.lp.property.filter' ));
