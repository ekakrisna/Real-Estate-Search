...
<div class="fav-section">
    <div class="container">
        ...
        <template v-if="!isLoading && !( favorites && favorites.length )">
            <div class="section-notif-no-data">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="content text-center">
                                <img src="{{ asset('frontend/assets/images/icons/bg_fav_property_nodata.png') }}" alt="icon_fav" class="icon-title">
                                <span class="text-title">お気に入りした物件はありません。</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="content-body content-icon-fav">
                            <div class="row">
                                ...
                                <!-- Property card - Start -->
                                <template v-else>
                                    <div class="col-12 col-lg-6 mb-3 mb-md-4 d-flex flex-column" v-for="( favorite, favoriteIndex ) in favorites" :key="favorite.id">
                                        <property-card :property="favorite.property" :log="favorite"></property-card>
                                    </div>
                                </template>
                                <!-- Property card - End -->
...
(function( $, io, document, window, undefined ){        
    ...
    mixin = {
        ...
        computed: {
            ...
            favorites: function(){ return io.get( this.state, 'result.data' )},
            // --------------------------------------------------------------
        },
        // ------------------------------------------------------------------
        ...
        watch: {
            ...
            $route: {
                immediate: true, handler: function( route ){
                    ...
                    var url = @json( route( 'frontend.fav-list.filter' ));
