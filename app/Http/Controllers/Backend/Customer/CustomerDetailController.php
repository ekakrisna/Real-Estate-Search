...
class CustomerDetailController extends Controller
{
    ...
    public function index($id)
    {
        ...
        if($data['customer_detail']->company_user != null){
        ...
        $data['customer_desired_area']           = CustomerDesiredArea::where('customers_id', $id)->with('city_areas')->with('city')->get();
        ...
        return view('backend.customer.detail.index', $data);
    }
}
